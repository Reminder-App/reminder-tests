package reminder.daterangepriority.br.unb.cic.reminders.model;

import java.util.regex.Matcher;
import java.util.regex.Pattern;
import reminder.daterangepriority.util.Patterns;
import reminder.daterangepriority.br.unb.cic.framework.persistence.DBTypes;
import
reminder.daterangepriority.br.unb.cic.framework.persistence.annotations.Column;
import
reminder.daterangepriority.br.unb.cic.framework.persistence.annotations.Entity;
import
reminder.daterangepriority.br.unb.cic.framework.persistence.annotations.ForeignKey;
import
reminder.daterangepriority.br.unb.cic.reminders.view.InvalidHourException;
