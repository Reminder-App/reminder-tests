package reminder.fixeddatepriority.br.unb.cic.reminders.model;

import java.util.regex.Matcher;
import java.util.regex.Pattern;
import reminder.fixeddatepriority.util.Patterns;
import reminder.fixeddatepriority.br.unb.cic.framework.persistence.DBTypes;
import
reminder.fixeddatepriority.br.unb.cic.framework.persistence.annotations.Column;
import
reminder.fixeddatepriority.br.unb.cic.framework.persistence.annotations.Entity;
import
reminder.fixeddatepriority.br.unb.cic.framework.persistence.annotations.ForeignKey;
import
reminder.fixeddatepriority.br.unb.cic.reminders.view.InvalidHourException;
