...
public class ExternalAddReminderActivity extends ReminderActivity {
	...
	/*** modified by dPriority* modified by dStaticCategory* modified by
	dManageCategory
	 */
	private void initialize() throws Exception {
		initialize_original8();
	...
	private void setNewCategory(Intent intent) throws Exception {
		setNewCategory_original6(intent);
	...
	/*** added by dStaticCategory* modified by dManageCategory
	 */
	private void setNewCategory_original6(Intent intent) throws Exception {
		String categoryName = intent.getStringExtra("category_name");
		List<Category> categories =
		Controller.instance(getApplicationContext()).listCategories();
		for(Category c : categories) {
	...
	dManageCategory
	 */
	private void initialize_original8() throws Exception {
