package reminder.fixeddateprioritymanagecategory.br.unb.cic.reminders.model;

import java.util.regex.Matcher;
import java.util.regex.Pattern;
import reminder.fixeddateprioritymanagecategory.util.Patterns;
import
reminder.fixeddateprioritymanagecategory.br.unb.cic.framework.persistence.DBTypes;
import
reminder.fixeddateprioritymanagecategory.br.unb.cic.framework.persistence.annotations.Column;
import
reminder.fixeddateprioritymanagecategory.br.unb.cic.framework.persistence.annotations.Entity;
import
reminder.fixeddateprioritymanagecategory.br.unb.cic.framework.persistence.annotations.ForeignKey;
import
reminder.fixeddateprioritymanagecategory.br.unb.cic.reminders.view.InvalidHourException;
