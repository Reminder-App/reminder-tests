...
public abstract class ReminderActivity extends Activity {
	...
	private void createReminder() {
		try {
			...
			Toast.makeText(getApplicationContext(), "Texto inv�lido.",
				Toast.LENGTH_SHORT).show();
		}
		catch(InvalidDateException e) {
			Toast.makeText(getApplicationContext(), "Data inv�lida.",
				Toast.LENGTH_SHORT).show();
		}
		catch(InvalidHourException e) {
			Toast.makeText(getApplicationContext(), "Hora inv�lida.",
				Toast.LENGTH_SHORT).show();
		}
		catch(Exception e) {
