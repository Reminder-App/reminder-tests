package reminder.fixeddatestaticcategory.br.unb.cic.reminders.model;

import java.util.regex.Matcher;
import java.util.regex.Pattern;
import reminder.fixeddatestaticcategory.util.Patterns;
import
reminder.fixeddatestaticcategory.br.unb.cic.framework.persistence.DBTypes;
import
reminder.fixeddatestaticcategory.br.unb.cic.framework.persistence.annotations.Column;
import
reminder.fixeddatestaticcategory.br.unb.cic.framework.persistence.annotations.Entity;
import
reminder.fixeddatestaticcategory.br.unb.cic.framework.persistence.annotations.ForeignKey;
import
reminder.fixeddatestaticcategory.br.unb.cic.reminders.view.InvalidHourException;
