package reminder.fixeddatemanagecategory.br.unb.cic.reminders.model;

import java.util.regex.Matcher;
import java.util.regex.Pattern;
import reminder.fixeddatemanagecategory.util.Patterns;
import
reminder.fixeddatemanagecategory.br.unb.cic.framework.persistence.DBTypes;
import
reminder.fixeddatemanagecategory.br.unb.cic.framework.persistence.annotations.Column;
import
reminder.fixeddatemanagecategory.br.unb.cic.framework.persistence.annotations.Entity;
import
reminder.fixeddatemanagecategory.br.unb.cic.framework.persistence.annotations.ForeignKey;
import
reminder.fixeddatemanagecategory.br.unb.cic.reminders.view.InvalidHourException;
